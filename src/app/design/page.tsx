...
const services = [
  {
    ...
    description:
      "We shape your vision, give it a distinct voice in tangible brand attributes, and announce it to the world. From the very first strategy session to the final brand rollout — every decision is intentional.",
    deliverables: [
      "Brand Strategy & Positioning",
      "Naming & Narrative Development",
    ...
    caseStudy: {
      label: "Rishaba Industries",
      desc: "Elevating India's Smart Essentials Brand",
  ...
  },
  {
    ...
    description:
      "We work with your teams to identify unique UX needs and deliver tailored solutions by humanising technology. We don't just design screens — we design decisions, flows, and feelings.",
    deliverables: [
    ...
    caseStudy: {
      label: "CodeFobe",
      desc: "Gamified Learning for Next-Gen Coders",
  ...
  },
  {
    ...
    description:
      "Packaging is where brand strategy meets consumer psychology. We craft packaging experiences that tell brand stories, connect with consumers, and stand out — whether on a physical shelf or a digital storefront.",
    deliverables: [
      "Structural & Dieline Design",
      "Surface Graphics & Typography",
      "Material & Finish Guidance",
      "Retail & E-commerce Adaptation",
      "Print Production Support",
      "Unboxing Experience Design",
    ],
    caseStudy: {
      label: "Kirchenwrapp",
      desc: "Rethinking Kitchenaid for Urban Homes",
  ...
  },
  {
    ...
    description:
      "We craft engaging narratives that entertain, educate, and inspire — bringing characters, products, and brands to life with world-class animation and visual effects.",
    deliverables: [
      "2D & 3D CGI",
      "Character Animation",
      "Motion Design & Brand Films",
      "VFX & Compositing",
    ...
    caseStudy: {
      label: "Groomré",
      desc: "AI-Powered Facial Hair Styler",
    ...
    <div className="pt-20">
      ...
      <div className="px-6 xl:px-10 py-20 md:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
          <div>
            <p className="text-xs font-semibold uppercase tracking-widest text-[#000000] mb-6">Design</p>
