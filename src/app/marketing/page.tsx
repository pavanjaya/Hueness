...
const services = [
  {
    ...
    description:
      "Before any campaign runs, any logo is drawn, or any content is written — your brand needs a clear point of view. We define where you stand, who you're talking to, and why they should care.",
    deliverables: [
    ...
    caseStudy: {
      label: "GM Design",
      desc: "Crafting the Brand for Grand Master of Interiors",
  ...
  },
  {
    ...
    description:
      "We build content ecosystems that attract, engage, and convert — across every channel and format. From thought leadership to social-first content, we make sure your brand always has something valuable to say.",
    deliverables: [
      ...
      "Blog, Video & Podcast Direction",
    ],
    caseStudy: {
      label: "LaunchX Labs",
      desc: "Social-Powered Review Platform Content",
  ...
  },
  {
    ...
    description:
      "Campaigns that reach the right audience at the right time — data-driven and creatively led. We manage performance marketing, social campaigns, and email — always with clear metrics and clear outcomes.",
    deliverables: [
    ...
    caseStudy: {
      label: "Mustang",
      desc: "Digital Refresh for Leading Sock Brand",
  ...
  },
  {
    ...
    description:
      "From strategy to execution — we plan and run product and brand launches that make an impact. Whether you're entering a new market or refreshing an existing one, we make sure the world notices.",
    deliverables: [
    ...
    caseStudy: {
      label: "Kinderlogica",
      desc: "Brand Design for Curiosity-Led Preschool",
    ...
    <div className="pt-20">
      ...
      <div className="px-6 xl:px-10 py-20 md:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
          <div>
            <p className="text-xs font-semibold uppercase tracking-widest text-[#000000] mb-6">Marketing</p>
